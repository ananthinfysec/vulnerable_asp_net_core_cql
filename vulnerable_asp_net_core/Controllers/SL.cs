...
{ 
    ...
    class Case3 
    {
        public Case3() {
            ...
            ServicePointManager.ServerCertificateValidationCallback = (Object requestSender, X509Certificate clientcert, X509Chain chain, SslPolicyErrors errors) =>
            {
                return clientcert.GetCertHashString().Equals("DocuSignConfiguration.ExportReportsKazMonTestCertThumbprint", StringComparison.InvariantCultureIgnoreCase);
            };
        }
    }
    ...
    // weird code just made up to make it run
    class StackOverflowPreventer : IDisposable
    {
        public static StackOverflowPreventer create(){
            return new StackOverflowPreventer();
        }
        public void Dispose(){}
    }
    ...
    class Case5
    {
        ...
        // Example (should match):
        public void UnsafeExampleMethod()
        {
            UnsafeExampleMethod();
        }
        
        // Example (should match):
        public void UnsafeExampleMethod1()
        {
            var x = DoThing();
            UnsafeExampleMethod1();
        }
        
        // Example (should match):
        public void UnsafeExampleMethod2()
        {
            using (StackOverflowPreventer.create())  // Used in the wrong place
            {
                var x = DoThing();
            }
            UnsafeExampleMethod2();
        }

        // Example (should NOT match):
        public void SafeExampleMethod3()
        {
            using (StackOverflowPreventer.create())
            {
                SafeExampleMethod3();
            }
        }
        // Example (should NOT match):
        public void SafeExampleMethod4()
        {
            var x = DoThing();
            using (StackOverflowPreventer.create())
            {
    ...
    class Case6
    {
        public static void Test(bool condition)
        {
            ...
            if (condition) {
                ...
                provider2.Dispose();  // This might not get hit
            }

            RSACryptoServiceProvider provider3 = new RSACryptoServiceProvider();
            provider3.Dispose();

            using (RSACryptoServiceProvider provider4 = new RSACryptoServiceProvider())
            {
    ...
    class Case7
    {
        ...
        public static bool UserIsAuthorized1()
        {
            return true;
        }
        public static void Test(bool condition)
    ...
    public class SL : Controller
    {
        ...
        public String customFilter(String s) {
            return s.Replace("<", "");
        }
        ...
        public IActionResult Index()
        {
            ...
            @ViewData["cookie"] =  customFilter(HttpContext.Request.Cookies["slcookie"]);
            @ViewData["result"] = id;
            return View();
        }
        ...
        public IActionResult XSS()
        {
            ...
            comment = "<b>" + comment + "</b>";
            var safe_comment = RequestUtils.GetIfDefined(Request, "comment");
            safe_comment = "foo" + safe_comment + "bar";
            
            Show("your comment is " + comment);
            Show("your comment is " + safe_comment);
